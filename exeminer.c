...
static const char def_conf[] = "exeminer.conf";
...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITHOUT_ARG("--scrypt",
			...
			"Use the scrypt algorithm for mining scrypt (NOT nscrypt!)"),
	OPT_WITHOUT_ARG("--nscrypt",
			opt_set_bool, &opt_nscrypt,
			"Use the nscrypt Execoin algorithm for mining (NOT scrypt!)"),
	...
	OPT_WITH_ARG("--thread-concurrency",
		     ...
		     "Set GPU thread concurrency for nscrypt Execoin mining, comma separated"),
#endif
	OPT_WITH_ARG("--url|-o",
		     set_url, NULL, NULL,
