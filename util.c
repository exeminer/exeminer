...
const long int nChainStartTime = 1390959880;
const long int nChangeInterval = 47335389;

unsigned char exe_GetNfactor(const long int nTimestamp) {

    if (nTimestamp <= nChainStartTime)
        return minNfactor;

    long int s = nTimestamp - nChainStartTime;
